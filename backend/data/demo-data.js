...
const orders = [
  {
    ...
    elapsed: 14,
    items: ["Tamarind Fish Curry", "Samosa Chaat"],
    amount: 540,
    safety: "Gluten conflict detected",
  },
  {
    id: "RP-1047",
    table: "T03",
  ...
  },
  {
    ...
    status: "READY",
    elapsed: 19,
    items: ["Baingan Bharta", "Dal Makhani"],
    amount: 385,
  },
  {
    id: "RP-1045",
...
const menu = [
  ...
  { id: "butter-chicken", name: "Butter Chicken", description: "Tender chicken cooked in rich, creamy, spiced tomato gravy", priceCents: 24500, prepMinutes: 17, tags: ["Gluten-free"], availability: "AVAILABLE", image: "https://images.unsplash.com/photo-1603894584373-59f69622edd0?w=500&q=80" },
...
module.exports = { restaurant, orders, menu, inventory, queue };
