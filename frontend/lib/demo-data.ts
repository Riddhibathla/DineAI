...
export const orders = [
  ...
  { id: "RP-1047", table: "T03", guest: "Noah Williams", status: "PREPARING", elapsed: 11, items: ["Heritage chicken x 2"], amount: 5600 },
  { id: "RP-1046", table: "T11", guest: "Ava Patel", status: "READY", elapsed: 19, items: ["Ember aubergine", "Wild mushroom pasta"], amount: 3650 },
  { id: "RP-1045", table: "T05", guest: "Liam Jones", status: "SUBMITTED", elapsed: 3, items: ["Citrus garden x 2"], amount: 2500 },
];
